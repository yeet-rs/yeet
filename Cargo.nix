        ...
        dependencies = [
          {
            ...
            target =
              { target, features }:
              (
                ("8" == target."pointer_width" or null)
                || ("16" == target."pointer_width" or null)
                || ("32" == target."pointer_width" or null)
              );
          }
          {
            name = "pear";
      ...
      "opentelemetry-otlp" = rec {
        ...
        features = {
          ...
          "experimental-grpc-retry" = [
            "grpc-tonic"
            "opentelemetry_sdk/experimental_async_runtime"
          ...
          "reqwest-blocking-client" = [
            "reqwest/blocking"
            "opentelemetry-http/reqwest-blocking"
          ];
          "reqwest-client" = [
            "reqwest"
      ...
      "zlink-core" = rec {
        ...
        features = {
          ...
          "idl-parse" = [
            "idl"
            "dep:winnow"
            "zlink-macros/idl-parse"
          ];
          "indexmap" = [ "dep:indexmap" ];
          "introspection" = [
            "idl"
            "zlink-macros/introspection"
          ];
          "proxy" = [ "zlink-macros/proxy" ];
          "service" = [
            "server"
            "zlink-macros/service"
            "introspection"
          ];
          "std" = [
            "dep:rustix"
