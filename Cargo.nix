  ...
  internal = rec {
    ...
    crates = {
      ...
      "jiff-sqlx" = rec {
        ...
        version = "0.2.0";
        edition = "2021";
        sha256 = "0n5w78n0901ivbz1y15zxpak67gkx2qz6ap30wawwigv7r77xw07";
        libName = "jiff_sqlx";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
      ...
      "opentelemetry-otlp" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "http" "http-proto" "internal-logs" "logs" "metrics" "opentelemetry-http" "prost" "reqwest" "reqwest-blocking-client" "trace" ];
      };
      "opentelemetry-proto" = rec {
        ...
        resolvedDefaultFeatures = [ "gen-tonic-messages" "logs" "metrics" "prost" "trace" ];
      };
      "opentelemetry_sdk" = rec {
        crateName = "opentelemetry_sdk";
        version = "0.32.0";
        edition = "2021";
        sha256 = "0mn9a0k7qj1jxycifa1bppwrhbf59gjzpf4v2w5z84216knzm2in";
        dependencies = [
          {
            name = "futures-channel";
            packageId = "futures-channel";
        ...
        resolvedDefaultFeatures = [ "default" "internal-logs" "logs" "metrics" "percent-encoding" "rand" "trace" ];
      };
      "option-ext" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-aws-lc-rs" "__tls" "blocking" "charset" "default" "default-tls" "http2" "json" "multipart" "query" "rustls" "system-proxy" ];
      };
      "reserve-port" = rec {
      ...
      "sqlx" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "_sqlite" "any" "default" "derive" "json" "macros" "migrate" "runtime-tokio" "sqlite" "sqlite-bundled" "sqlite-deserialize" "sqlite-load-extension" "sqlite-unlock-notify" "sqlx-macros" "sqlx-sqlite" "uuid" ];
      };
      "sqlx-core" = rec {
        crateName = "sqlx-core";
        version = "0.9.0";
      ...
      "sqlx-macros" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "default" "derive" "json" "macros" "migrate" "sqlite" "sqlite-load-extension" "uuid" ];
      };
      "sqlx-macros-core" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "_sqlite" "default" "derive" "json" "macros" "migrate" "sqlite" "sqlite-load-extension" "sqlx-sqlite" "thiserror" "tokio" "uuid" ];
      };
      "sqlx-mysql" = rec {
      ...
      "sqlx-sqlite" = rec {
        ...
        resolvedDefaultFeatures = [ "any" "bundled" "deserialize" "json" "load-extension" "migrate" "offline" "serde" "unlock-notify" "uuid" ];
      };
      "ssh-cipher" = rec {
      ...
      "yeetd" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "sqlx";
            packageId = "sqlx";
            features = [ "runtime-tokio" "sqlite" "json" "runtime-tokio" "sqlite" "uuid" ];
          }
          {
            name = "thiserror";
            packageId = "thiserror 2.0.18";
